 ...
 */
 ...
 /**
  * 
  *   fn()'s needed for tables
  * 
  */
 
 /** 
  * GET: retrieve all existing tables.
  * @params signal
  * optional AbortController.signal
 ...
 /** 
  * POST: new table to the database
  * @param table
  *  the new table data
  * @param signal
  *  optional AbortController.signal
 ...
 /** 
  * PUT: update to a table's status in the database
 ...
 /** 
  * DELETE: remove reservation_id from a table
  * @param table_id
  * the id of the specified table
  * @param signal
  * optional AbortController.signal
 ...
 /** 
  * DELETE: remove table_id from dashboard
  * @param table_id
  * the id of the specified table
  * @param signal
  * optional AbortController.signal
